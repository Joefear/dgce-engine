...
def test_stage3_review_bundle_document_covers_locked_surfaces_and_boundaries():
    ...
    for required in (
        ...
        "Final lock declaration commit: pending commit assignment",
        "`09f46dc`",
        "`ed161fb`",
        "`5447b6f`",
        "`239c6b5`",
        ...
        "Stage 3 runs after Stage 2 Preview and before Stage 4 Approval",
        "Stage 3 stops at human review",
        "Stage 3 does not approve",
        "Stage 3 does not execute",
        "Stage 3 does not advance lifecycle beyond review",
        "Stage 3 writes only the review artifact",
        "Stage 3 does not write approval, gate, alignment, simulation, execution, output, Unreal project, or Blueprint artifacts.",
        "Valid Unreal package/source paths are accepted",
        "Traversal/backslash paths are rejected",
        "Stage 4 Approval is the next logical contract milestone",
        "no Stage 4 implementation is authorized",
        "source_preview_fingerprint",
        "source_input_fingerprint",
        "proposed_changes",
        "evidence",
