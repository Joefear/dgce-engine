...
def _system_breakdown_generation_prompt(section: DGCESection) -> str:
    ...
    return (
        ...
        "Use explicit top-level keys modules, build_graph, tests, determinism_rules, and acceptance_criteria.\n"
